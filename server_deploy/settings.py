"""
Django settings for server_deploy project.
...
SECRET_KEY = 'django-insecure-y0adz=m)sf3y1acl=fpid@pzeplgj%71l$@8i63q)wm3#n@+g9'
...
WSGI_APPLICATION = 'server_deploy.wsgi.application'
